...
namespace HashLib
{
    internal static class Converters
    {
        ...
        internal static uint[] ConvertBytesToUInts(byte[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
        ...
        internal static void ConvertBytesToUInts(byte[] a_in, int a_index, int a_length, uint[] a_out)
        {
            Check(a_in, 1, 4, a_index, a_length);
        ...
        internal static ulong[] ConvertBytesToULongs(byte[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static void ConvertBytesToULongs(byte[] a_in, int a_index_in, int a_length, ulong[] a_out, int a_index_out)
        {
        ...
        internal static uint[] ConvertBytesToUIntsSwapOrder(byte[] a_in, int a_index, int a_length)
        {
            Check(a_in, 1, 4, a_index, a_length);
        ...
        internal static void ConvertBytesToUIntsSwapOrder(byte[] a_in, int a_index, int a_length, uint[] a_result, int a_index_out)
        {
        ...
        internal static ulong ConvertBytesToULongSwapOrder(byte[] a_in, int a_index)
        {
        ...
        internal static ulong ConvertBytesToULong(byte[] a_in, int a_index)
        {
            Debug.Assert(a_index >= 0);
            Debug.Assert(a_index + 8 <= a_in.Length);
        ...
        internal static uint ConvertBytesToUIntSwapOrder(byte[] a_in, int a_index)
        {
            Debug.Assert(a_index >= 0);
        ...
        internal static uint ConvertBytesToUInt(byte[] a_in, int a_index = 0)
        {
            Debug.Assert(a_index >= 0);
            Debug.Assert(a_index + 4 <= a_in.Length);
        ...
        internal static ulong[] ConvertBytesToULongsSwapOrder(byte[] a_in, int a_index, int a_length)
        {
            Check(a_in, 1, 8, a_index, a_length);
        ...
        internal static void ConvertBytesToULongsSwapOrder(byte[] a_in, int a_index, int a_length, ulong[] a_out)
        {
            Check(a_in, 1, 8, a_index, a_length);
        ...
        internal static byte[] ConvertUIntsToBytesSwapOrder(uint[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static byte[] ConvertUIntsToBytes(uint[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static byte[] ConvertULongsToBytes(ulong[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static byte[] ConvertULongsToBytesSwapOrder(ulong[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static byte[] ConvertUIntToBytes(uint a_in)
        {
        ...
        internal static void ConvertUIntToBytes(ulong a_in, byte[] a_out, int a_index)
        {
        ...
        internal static byte[] ConvertULongToBytes(ulong a_in)
        {
        ...
        internal static void ConvertULongToBytes(ulong a_in, byte[] a_out, int a_index)
        {
        ...
        internal static void ConvertULongToBytesSwapOrder(ulong a_in, byte[] a_out, int a_index)
        {
            Debug.Assert(a_index + 8 <= a_out.Length);
        ...
        internal static byte[] ConvertStringToBytes(string a_in)
        {
        ...
        internal static byte[] ConvertStringToBytes(string a_in, Encoding a_encoding)
        {
            return a_encoding.GetBytes(a_in);
        }

        internal static byte[] ConvertCharsToBytes(char[] a_in)
        {
            Check(a_in, 2, 1);
        ...
        internal static byte[] ConvertShortsToBytes(short[] a_in)
        {
            Check(a_in, 2, 1);
        ...
        internal static byte[] ConvertUShortsToBytes(ushort[] a_in)
        {
            Check(a_in, 2, 1);
        ...
        internal static byte[] ConvertIntsToBytes(int[] a_in)
        {
            Check(a_in, 4, 1);
        ...
        internal static byte[] ConvertLongsToBytes(long[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static byte[] ConvertDoublesToBytes(double[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static byte[] ConvertFloatsToBytes(float[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static ulong[] ConvertFloatsToULongs(float[] a_in, int a_index = 0, int a_length = -1)
        {
            if (a_length == -1)
                a_length = a_in.Length;
        ...
        internal static void ConvertFloatsToULongs(float[] a_in, int a_index_in, int a_length, ulong[] a_out, int a_index_out)
        {
        ...
        internal static byte[] ConvertHexStringToBytes(string a_in)
        {
            a_in = a_in.Replace("-", "");
        ...
        internal static string ConvertBytesToHexString(byte[] a_in, bool a_group = true)
        {
