...
namespace DataGridFilterLibrary
{
    public class DataGridExtensions
    {
        ...
        public static DependencyProperty IsFilteringEnabledProperty =
            DependencyProperty.RegisterAttached("IsFilteringEnabled",
                typeof(bool?), typeof(DataGridExtensions),
                  new FrameworkPropertyMetadata(true));

        public static bool? GetIsFilteringEnabled(
            DependencyObject target)
        {
            return (bool)target.GetValue(IsFilteringEnabledProperty);
        }

        public static void SetIsFilteringEnabled(
            DependencyObject target, bool? value)
        {
            target.SetValue(IsFilteringEnabledProperty, value);
        }
    }
}
