...
namespace ErrH.UploaderApp.AppFileRepository
{
    public class AppFileRepo : LogSourceBase, ID7Repo, ILogSource
    {
        ...
        private D7RepoBase<AppFileRepo_Dto> _repoBase;
        ...
        {
            this._repoBase = ForwardLogs(new D7RepoBase<AppFileRepo_Dto>(d7Client));
        ...
        public ReadOnlyCollection<AppNode> Apps
        {
            get
            {
        ...
        private List<AppFileRepo_Dto> FilterByAppNid(int appNid)
        {
